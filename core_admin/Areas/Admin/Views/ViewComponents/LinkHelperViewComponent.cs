...
{
    public class LinkHelperViewComponent : ViewComponent
    {
        ...
        public LinkHelperViewComponent(IWebHostEnvironment hostingEnvironment, IConfiguration iConfig, IHttpContextAccessor iContext)
        {
            _config = iConfig;
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            */
            ...
            return View("~/Areas/Admin/Views/Shared/_PartialLinkHelper.cshtml");
        }
    }
}
