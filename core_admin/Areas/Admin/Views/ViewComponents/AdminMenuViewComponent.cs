...
namespace thaicredit_hr_admin.Areas.Admin.Views.ViewComponents
{
    public class AdminMenuViewComponent : ViewComponent
    {
        ...
        public AdminMenuViewComponent(IWebHostEnvironment hostingEnvironment, IConfiguration iConfig, IHttpContextAccessor iContext)
        {
            _config = iConfig;
        ...
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            return View("~/Areas/Admin/Views/Shared/_PartialAdminMenu.cshtml", AdminMenu);
        }
    }
}
