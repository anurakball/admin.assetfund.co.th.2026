...
namespace thaicredit_hr_admin.Areas.Admin.Views.ViewComponents
{
    public class AdminBreadcrumbViewComponent : ViewComponent
    {
        ...
        public AdminBreadcrumbViewComponent(IWebHostEnvironment hostingEnvironment, IConfiguration iConfig, IHttpContextAccessor iContext)
        {
            _config = iConfig;
        ...
        public async Task<IViewComponentResult> InvokeAsync(Module Module = null, List<string> Breadcrumb = null)
        {
            ...
            return View("~/Areas/Admin/Views/Shared/_PartialAdminBreadcrumb.cshtml");
        }
    }
}
